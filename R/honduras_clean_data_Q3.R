...
raw_data_ridl <- 'https://ridl.unhcr.org/dataset/3598478a-b9b1-4e38-a05f-ad731a87e825/resource/dcf847ab-b975-4d91-bfaf-7c2301946944/download/survey-xlsx-data__a96x4w65wpvxkwfm7u2e6i_data.xlsx'   
...
df_wrangle <- df_wrangle |> 
  ...
  select(a_introduction_a04_country = a_introduction_label_co_i,
        ...
        #  B004_nationality_other = questionnaire_b_biodata_b004_nationality_other_3,
         ...
         B010_documentation = questionnaire_b_demographics_f05_documents,
         B010_documentation_other = questionnaire_b_demographics_f05_documents_other_2,
...
df_wrangle <- df_wrangle |> 
  mutate(a_introduction_a04_country = "Honduras") 
...
df_wrangle <- df_wrangle |> 
  filter(!(id %in% c("31354066", "31359042", "31397363", 
                     "32512097", "32512098", "32512101",
                     "32528114", "32528113", "32632651", 
                     "32668859","32679264") 
         & uuid %in%  c("3b8fe22a-ae57-45e8-903e-7d55e3beee56", "601da281-a908-4cb5-90f4-ec4d8c9a4792", "37452cf2-9e3d-4393-a3ff-b9c887bb34bd",
                     "e48d9d83-e2aa-41c8-95f6-4f49cd580ccc", "3166a208-d9b5-40ca-8aa1-bb3a4a7c3793", "97b4b15e-fd44-4d18-986d-54e9e5ddb8df",
                     "2be4d2fd-b50f-42b5-a796-216df0d5e09d", "c3f719f0-c10e-460c-a6e3-7404f625f86a", "197935ed-2c13-4d2d-875d-b6444b752e9f",
                     "1c7c46ca-5f1c-4c84-9651-07eb4819e4f3", "412a332a-c8ed-4a55-9044-7805cc86922c")
         ))
