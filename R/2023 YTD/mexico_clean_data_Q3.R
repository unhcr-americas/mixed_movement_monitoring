...
df_fam_doc <- resource_fetch(raw_data_ridl)|>
  ...
  clean_names() |> 
  select(questionnaire_family_status_countries_label_country = questionnaire_b_demographics_family_status_countries_label_country,
         questionnaire_family_status_countries_b09_fam_status = questionnaire_b_demographics_family_status_countries_b09_fam_status,
  ...
  mutate(questionnaire_family_status_countries_b09_fam_status = str_replace_all(questionnaire_family_status_countries_b09_fam_status, "dontknow", "dont_know"))
